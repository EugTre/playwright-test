...
class AdminCountriesPage(AdminBasicCategoryPage):
    ...
    def get_countries(self) -> list:
        ...
        self.log("Countries table has %s items",
                 len(countries_names))
        self.log('List of countries in table: %s',
                 countries_names, level=DEBUG)
    ...
    def country_list_size_should_be(self, size: int):
        ...
        self.log("Checking size of the 'Countries' table to be %s",
                 size)
